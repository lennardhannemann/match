...
def creating_session(subsession:Subsession):
    ...
    r2 = csv.reader(open(r"/Users/lennardhannemann/Desktop/pricelist_all.csv"), delimiter=";")
    y2 = list(r2)
...
class Investment(Page):
    # create words and sentences which depends on treatment
    def vars_for_template(player:Player):
        ...
        if p.treat == 0:
            ...
            d = "In a price chart, the historical development of an asset's price over one year can be seen."
            a = "Each price chart starts at a price of 100."

        elif p.treat == 1:
            c = "a return chart of an asset will be displayed"
            d = "In a return chart, the historical sequence of returns over one year can be seen."
            a = ""
        else:
            c = "the weekly prices over one year of an asset is displayed in a list"
            d = ""
            a = ""
        p = player.session
...
page_sequence = [Introduction, General, Investment, Payout]
